...
function init1() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    opts = {
      ...
      strings_1: [
        ["  Happy Birthday!", "  Pawanpreet Kaur  "],
        ["   May all the happiness,"],
        ["all the luck"],
        [" always surround", "you  "],
        [
          "  Now welcome the",
          "    Minions to celebrate",
          "   your birthday haha~",
        ],
      ],
  ...
  for (let i = 0; i < opts.strings_1.length; i++) {
    let totalWidth = 0;
    totalWidth = opts.charSpacing * opts.strings_1[i][0].length;
  ...
  function message() {
    window.alert(
      "A Little present from your brother! You are my cute little princess! Another present is on its way! ~ Gurshehzad Singh"
    );
    document;
  }
